...
# Cerca l'iperonimo comune di più vicino ai due synset
...
## distanza tra synset
# creo dict con key synset antenato e value la distanza, eseguo intersezione e cerco la somma minima
...
def similarity(word1, word2, function_name):
    ...
    for w1_syn in wn.synsets(word1):
        for w2_syn in wn.synsets(word2):
            ...
            elif function_name == 'wu_palmer2':
                res = wup_similarity2(w1_syn, w2_syn)
            else:
                raise ValueError()
...
def calculate_similarity(list_keys):
    ...
    for key in list_keys:
        ...
        _wu_palmer_result2.append(similarity(key[0], key[1], 'wu_palmer2'))
    ...
    return _wu_palmer_result,_wu_palmer_result2, _shortest_path_result, _leakcock_chodorow_result
...
if __name__ == "__main__":
    ...
    # calcolo similarità
    wu_palmer_result, wu_palmer_result2, shortest_path_result, leakcock_chodorow_result = calculate_similarity(list)

    # stampo risultati
    print("WU PALMER RESULT:")
    print("Pearson: ", scipy.stats.pearsonr(wu_palmer_result, target_result)[0])
    print("Spearman: ", scipy.stats.spearmanr(wu_palmer_result, target_result)[0])
    print("WU PALMER RESULT 2:")
    print("Pearson: ", scipy.stats.pearsonr(wu_palmer_result2, target_result)[0])
    print("Spearman: ", scipy.stats.spearmanr(wu_palmer_result2, target_result)[0])

    print("\nShortest Path:")
    print("Pearson: ", scipy.stats.pearsonr(shortest_path_result, target_result)[0])
    print("Spearman: ", scipy.stats.spearmanr(shortest_path_result, target_result)[0])

    print("\nLeakcock Chodorow RESULT:")
    print("Pearson: ", scipy.stats.pearsonr(leakcock_chodorow_result, target_result)[0])
    print("Spearman: ", scipy.stats.spearmanr(leakcock_chodorow_result, target_result)[0])
...
WU PALMER RESULT:
Pearson:  0.2370800233916329
Spearman:  0.30213025567800406
WU PALMER RESULT 2:
Pearson:  0.24664847048201893
Spearman:  0.2946199406306289

Shortest Path:
Pearson:  0.13923527936170196
Spearman:  0.2635380400056134

Leakcock Chodorow RESULT:
Pearson:  0.29242769127819757
Spearman:  0.2635380400056134
'''